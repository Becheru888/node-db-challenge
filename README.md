...
* So: the RD is the system, and SQL is the language used to interact with the system. In principle you could have an RD that uses some other language for access, and in principle you could use SQL to interact with some other kind of database system, though in practice the two are closely coupled.

1. Why do tables need a `primary key`?

* This is needed to uniquely identify each record in a table and also good for table row indexing
